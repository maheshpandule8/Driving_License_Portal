...
With steady steps in direction of achievement of its Vision, Mission and objectives , the ministry is progressing towards provision of improved service access to citizens with quality and efficiency in service delivery, transparency in the system and reduced workload for RTO staff.
                            ...
                            <div class="row text-center">
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-white rounded shadow-sm py-5 px-4">
                                        ...
                                        />
                                        <h5 class="mb-0">Rushikesh Tondlekar</h5>
                                        <h6>PRN - 230340320090</h6>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-white rounded shadow-sm py-5 px-4">
                                        <img
                                            ...
                                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                                        />
                                        <h5 class="mb-0">Pratik Dubal </h5>
                                        <h6>PRN - 230340320077</h6>
                                        <span class="small text-uppercase text-muted">
                                        SOFTWARE DEVELOPER
                                        </span>
                                    </div>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-white rounded shadow-sm py-5 px-4">
                                        <img
                                            ...
                                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                                        />
                                        <h5 class="mb-0">Ajinkya Lendikar</h5>
                                        <h6>PRN - 230340320008</h6>
                                        <span class="small text-uppercase text-muted">
                                        SOFTWARE DEVELOPER
                                        </span>
                                    </div>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-white rounded shadow-sm py-5 px-4">
                                        <img
                                            ...
                                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                                        />
                                        <h5 class="mb-0">Raviraj Patil</h5>
                                        <h6>PRN - 230340520073</h6>
                                        <span class="small text-uppercase text-muted">
                                        SOFTWARE DEVELOPER
                                        </span>
                                    </div>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-white rounded shadow-sm py-5 px-4">
                                        <img
                                            ...
                                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                                        />
                                        <h5 class="mb-0">Somesh Sonpethkar</h5>
                                        <h6>PRN - 230340520104</h6>
                                        <span class="small text-uppercase text-muted">
                                            SOFTWARE DEVELOPER
                                        </span>
                                    </div>
    ...
    <h3 className='mt-4'>Sangli RTO office Location</h3>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3819.064064391435!2d74.64153727490852!3d16.823177618814206!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc123afaf32c3b5%3A0x651a5484d282f8dc!2sRto%20office%20sangli!5e0!3m2!1sen!2sin!4v1692975610251!5m2!1sen!2sin" width="600" height="450" style={{border:"0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
